...
export const gameEvents = pgTable(
  ...
  (table) => ({
    ...
    gameIdEventIdx: uniqueIndex("game_events_game_id_event_index_idx").on(
      table.gameId,
      table.eventIndex
    ),
  })
...
export const playerLifetimeStats = pgTable(
  "player_lifetime_stats",
  {
    ...
    totalMisplays: integer("total_misplays").notNull().default(0),
...
export type PlayerProfileInput = Pick<
  PlayerProfile,
  "displayName" | "avatarSeed" | "color" | "userId"
> & {
  isBot?: boolean;
};
